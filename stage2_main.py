...
import argparse
from utilities_s2 import utils
...
parser.add_argument('-ds', '--data-set', default='NIH-CHEST', type=str, help="Data set [MS-COCO, VOC2007,NIH-CHEST,MIMIC,CHEXPERT]")
parser.add_argument('-dr', '--data-root', default=r'/data/nih-chest-xrays', type=str, help="Your Data Set Root")
...
if __name__ == "__main__":
    ...
    # <--- 6. 替换 `if __name__ == '__main__':` 的全部内容
    if 'LOCAL_RANK' in os.environ:
        args.local_rank = int(os.environ['LOCAL_RANK'])
    # 7. 新的 init 函数将处理 DDP 或单 GPU 设置
