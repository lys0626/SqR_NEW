...
parser.add_argument('-ds', '--data-set', default='NIH-CHEST', type=str, help="Data set [MS-COCO, VOC2007,NIH-CHEST,MIMIC,CHEXPERT,PADCHEST]")
...
parser.add_argument('--soft_label_path', type=str, default='', 
                        help='Path to the asymmetric_soft_targets.pt generated by Stage 1')
parser.add_argument('--use_stage1_reliability', action='store_true', default=False,
                    help='Use Stage 1 label reliability and FP/FN masks to weight Stage 2 loss')
parser.add_argument('--label_reliability_path', type=str, default='',
                    help='Path to label_reliability.pt generated by Stage 1')
parser.add_argument('--fp_mask_path', type=str, default='',
                    help='Path to fp_mask.pt generated by Stage 1')
parser.add_argument('--fn_mask_path', type=str, default='',
                    help='Path to fn_mask.pt generated by Stage 1')
parser.add_argument('--hard_clean_mask_path', type=str, default='',
                    help='Path to hard_clean_mask.pt generated by Stage 1')
parser.add_argument('--reliability_min_weight', type=float, default=0.2,
                    help='Minimum per-label loss weight when Stage 1 reliability is used')
parser.add_argument('--fp_loss_weight', type=float, default=0.3,
                    help='Upper-bound loss weight for clear false-positive labels')
parser.add_argument('--fn_loss_weight', type=float, default=0.7,
                    help='Lower-bound loss weight for recovered false-negative labels')
